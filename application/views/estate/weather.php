...
<body>
    ...
    <script>
        ...
        async function searchApiRequest(searchText) {
            ...
            let responce = await fetch(`https://api.open-meteo.com/v1/forecast?latitude=6.888645&longitude=79.858096&current=cloud_cover&daily=weather_code,temperature_2m_max,temperature_2m_min,daylight_duration,precipitation_sum,rain_sum,showers_sum,precipitation_hours,wind_direction_10m_dominant&timezone=Asia%2FBangkok&start_date=2024-01-14&end_date=2024-01-14`);
